          ...
          {[
            {
              ...
              description:
                "Conjunto de landing pages desenvolvidas para captação de leads de credores e investidores, com foco em performance, conversão, estabilidade e fidelidade total ao design definido no Figma.",
              details: [
                "Liderança técnica na implementação completa das landing pages (Credor, Credor 02 e Investidor), desde a definição da arquitetura até a entrega em produção",
                ...
                "Contribuição direta para o aumento da geração de leads qualificados, fortalecendo as estratégias de aquisição da plataforma",
              ],
              tech: [
                "React",
                "Next.js",
            ...
            },
            {
              ...
              description:
                "Sistema web para acompanhamento de investimentos, permitindo que investidores visualizem spreads, posições, extratos detalhados e validem transações em blockchain em tempo real.",
              details: [
...

            {
              title: "Boletador",
              description:
                "Sistema que automatiza o processo de vendas de ativos, gerando contratos e iniciando transações com clientes.",
              details: [
            ...
            },
            {
              ...
              description:
                "Plataforma desenvolvida para entes federativos, com foco na tokenização de precatórios para quitação de dívidas via compensação.",
              details: [
                "Liderança técnica no desenvolvimento da plataforma, atuando na definição da arquitetura, tecnologias e boas práticas",
                "Atuação hands-on em todas as camadas do projeto, do front-end ao back-end e infraestrutura",
                "Mentoria e suporte técnico ao time, disseminando boas práticas de desenvolvimento, organização de código e padrões de projeto",
