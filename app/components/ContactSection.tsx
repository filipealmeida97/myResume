				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<h2 className="text-3xl font-bold mb-8 text-gray-200">Vamos conectar</h2>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<motion.a
									href="https://github.com/filipealmeida97"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@filipealmeida97</p>
									</div>
								</motion.a>
								<motion.a
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">Filipe Almeida</p>
									</div>
								</motion.a>
							</div>
						</div>
